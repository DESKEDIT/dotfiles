...
Rectangle {
  ...
  bottomLeftRadius: Dat.Globals.radius
  bottomRightRadius: Dat.Globals.radius
  clip: true
  color: Dat.Colors.background//Dat.Colors.withAlpha(Dat.Colors.background, 1)//(Dat.Globals.actWinName == "desktop" && Dat.Globals.notchState != "FULLY_EXPANDED") ? 0.79 : 0.89)
